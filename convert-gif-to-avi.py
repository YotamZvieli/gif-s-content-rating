...
if __name__ == '__main__':
    ...
    video_file_paths_class_g = list(dataset_root_path.glob("train/g/*.gif"))
    video_file_paths_class_pg = list(dataset_root_path.glob("train/pg/*.gif"))
    video_file_paths_class_pg13 = list(dataset_root_path.glob("train/pg-13/*.gif"))
    video_file_paths_class_r = list(dataset_root_path.glob("train/r/*.gif"))

    for gif_path in (video_file_paths_class_g + video_file_paths_class_pg13 + video_file_paths_class_pg):
        gif = Image.open(gif_path)

        split_path = gif_path.parts
        avi_path = "gifs/DL project - gifs/train_avi/" + split_path[-2] + "/" + split_path[-1] + ".avi"
